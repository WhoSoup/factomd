...
func init() {
	...
	GlobalLogger = logging.NewSequenceLogger(logging.NewFileLogger("./."))
	GlobalLogger.AddNameField("fnode", logging.Formatter("%s"), "")
	GlobalLogger.AddNameField("logname", logging.Formatter("%s.txt"), "unknown-log")
	//Add the default print fields comment then message
	GlobalLogger.AddPrintField("dbht", logging.Formatter("%12s"), "")
	GlobalLogger.AddPrintField("comment", logging.Formatter("[%-45v]"), "")
	GlobalLogger.AddPrintField("hash", logging.Formatter("%-38v"), "")
